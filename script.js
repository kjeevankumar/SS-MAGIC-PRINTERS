...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const GLOBAL_PRODUCT_NAMES = {
        ...
        'images  750': 'Sleek White Personalized Bottle (750 ml)',
        'images (1)': 'Custom Graphic Steel Bottle (500 ml)',
        'images (10) 499': 'Vacuum Insulated Travel Mug (500 ml)',
        'images (2)': 'Minimalist Photo Printed Bottle (750 ml)',
        'images (4) 750': 'Classic White Sports Bottle (750 ml)',
        ...
        'images (8)': 'Artistic Personalized Bottle (750 ml)',
    ...
    fetch('catalog-manifest.json?v=' + Date.now()).then(resp => {
        ...
        catalogData = [{ key: 'misc', title: 'Products', images: [] }];
        renderCatalogFilters();
        renderCatalogProducts('misc');
    });
